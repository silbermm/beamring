defmodule BeamringWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BeamringWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BeamringWeb.Gettext, "errors", msg, opts)
    end
  end
